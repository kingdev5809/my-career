...
export function* LoadAll(action) {
	const { entity, name, url, params, dataKey, metaKey, appendData, prependData, primaryKey, relations, onSuccess } = action.payload;
	...
	try {
		...
		const normalized = normalize(typeof dataKey === "function" ? dataKey(data) : data[dataKey], [EntitySchema(entity, primaryKey, relations)]);
...
export default function* root() {
	yield all([
		takeLatest(Actions.entity.LoadAll.REQUEST, LoadAll),
		takeLatest(Actions.entity.LoadOne.REQUEST, LoadOne),
